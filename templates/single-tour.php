...
<div id="overview">
	<div class="row tour-intro">
		<div class="col-sm-5 col-sm-push-7 vcenter">
			<div class="tour-style-box uppercase">		
				...
				$numDays = floor($timeDiff/86400);  // 86400 seconds in one day
				$numNights = $numDays - 1;
				?>
		...
		<div class="col-sm-7 col-sm-pull-5 vcenter">
			<h3><?php the_title(); ?></h3>
			<h4>Turkey ham hock tri-tip doner leberkas shankle pork beef ribs.</h4>
			<p>Bacon ipsum dolor sit amet hamburger meatball pork loin shoulder capicola, pancetta short loin kevin tail ribeye swine. Strip steak kielbasa landjaeger, prosciutto t-bone pastrami bresaola tongue chuck. Hamburger pork loin kevin, ham doner chuck pork chop leberkas. Pork belly filet mignon drumstick frankfurter. Pork filet mignon fatback, hamburger ball tip sirloin andouille spare ribs shankle beef shank prosciutto pork chop corned beef. Brisket pork tongue andouille porchetta short loin.</p>
		</div>
	</div>
</div>
...
<div id="journey">
	...
	<ul class="journey-menu row sliding-top-nav">
...
<div id="accomodations">
	...
	if( $hotels ): ?>
		...
		<ul class="accomodations-menu row sliding-top-nav">
...
<div id="scenery">
	...
	<div class="row full-row flex-full-width-img">
		<img src="/wp-content/uploads/2014/05/hero-couple.png">
		<div class="text-overlay">Enjoy the Scenery</div>
	...
	<div class="row">
			...
			$image_ids = get_field('tour_gallery', false, false);
